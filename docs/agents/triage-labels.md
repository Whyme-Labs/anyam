...
When a skill refers to a canonical role, use the corresponding GitHub label from this table. Edit the right-hand column if the repository's label vocabulary changes.
